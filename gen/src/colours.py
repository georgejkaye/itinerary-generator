...
def get_segment_colour(
    ...
    possible_colours = get_service_colour(route_identifier)
    ...
    try:
        ...
        fg_colour = input("Foreground colour: ")
        bg_colour = input("Background colour: ")
    # record_colours(colour_directory, route_identifier, fg_colour, bg_colour)
